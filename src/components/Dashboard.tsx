...
import { Download, Upload, BarChart3, Package, TrendingUp, Users, Bell, Calendar, Settings, User, Zap, Gift, Map, Truck, Clock, Brain, LogOut, ChevronDown, HelpCircle, MessageCircle } from "lucide-react";
        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-56 bg-white">
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem onClick={openAboutUs}>
                <HelpCircle className="mr-2 h-4 w-4" />
                About Us
              </DropdownMenuItem>
              <DropdownMenuItem onClick={openContactUs}>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li><button onClick={() => handleTabChange('forecast')} className="hover:text-blue-600 transition-colors text-left">Demand Forecasting</button></li>
                <li><button onClick={() => handleTabChange('pricing')} className="hover:text-blue-600 transition-colors text-left">Price Optimization</button></li>
                <li><button onClick={() => handleTabChange('inventory')} className="hover:text-blue-600 transition-colors text-left">Inventory Management</button></li>
                <li><button onClick={() => handleTabChange('sales')} className="hover:text-blue-600 transition-colors text-left">Sales Analytics</button></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li><button onClick={() => handleTabChange('competitors')} className="hover:text-blue-600 transition-colors text-left">Competitor Analysis</button></li>
                <li><button onClick={() => handleTabChange('bundles')} className="hover:text-blue-600 transition-colors text-left">Bundle Intelligence</button></li>
                <li><button onClick={() => handleTabChange('suppliers')} className="hover:text-blue-600 transition-colors text-left">Supplier Insights</button></li>
                <li><button onClick={() => handleTabChange('heatmap')} className="hover:text-blue-600 transition-colors text-left">Sales Heatmap</button></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                ...
                <li><button onClick={openContactUs} className="hover:text-blue-600 transition-colors text-left">Help Center</button></li>
                <li><button onClick={openContactUs} className="hover:text-blue-600 transition-colors text-left">Contact Support</button></li>
                <li><button onClick={openAboutUs} className="hover:text-blue-600 transition-colors text-left">About Us</button></li>
              </ul>
            </div>
          </div>
