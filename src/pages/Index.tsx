      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700" onClick={() => {
              setAuthMode('signup');
              setShowAuthModal(true);
            }}>
              Start Free Trial
        ...
        <div className="container mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><a href="https://docs.lovable.dev" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Documentation</a></li>
                <li>API Reference</li>
                <li>Help Center</li>
                <li>Case Studies</li>
                <li>Blog</li>
          ...
          <div className="border-t border-gray-800 pt-8 mt-8 text-center text-gray-400">
            <p>© 2025 ForecastGenius. All rights reserved.</p>
          </div>
        </div>
      </footer>
